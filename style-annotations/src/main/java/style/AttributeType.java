...
public enum AttributeType {
    ...
    FLOAT(Float.class.getName(), TypeKind.FLOAT, Constants.METHOD_GET_FLOAT),
    INT(Integer.class.getName(), TypeKind.INT, Constants.METHOD_GET_INT),
    INTEGER(Integer.class.getName(), TypeKind.INT, Constants.METHOD_GET_INTEGER),
    LAYOUT_DIMENSION(Integer.class.getName(), TypeKind.INT, Constants.METHOD_GET_LAYOUT_DIMEN),
    NON_RESOURCE_STRING(String.class.getName(), null, Constants.METHOD_GET_NON_RES_STRING),
    RESOURCE_ID(Integer.class.getName(), TypeKind.INT, Constants.METHOD_GET_RES_ID),
    STRING(String.class.getName(), null, Constants.METHOD_GET_STRING),
    TEXT(CharSequence.class.getName(), null, Constants.METHOD_GET_TEXT),
